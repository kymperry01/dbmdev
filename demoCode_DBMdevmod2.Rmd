...
## Running phenological models for diamondback moth using custom R package DBMdevmod2

This document demonstrates how to run Briere's temperature-based model to predict the development rate of diamondback moth, Plutella xylostella, using custom R package DBMdevmod2.
...
hourlyDf <- DBMdevmod2::hourlyTemperatures(dailyDf)
